...
curl https://raw.githubusercontent.com/efortin/multipass-netlistener/master/build/networklistener -o /usr/local/bin/networklistener
chown root:wheel /usr/local/bin/networklistener
chmod 500 /usr/local/bin/networklistener

echo "Copy application and fix permissions"
curl https://raw.githubusercontent.com/efortin/multipass-netlistener/master/deployments/networklistener.plist -o /Library/LaunchDaemons/networklistener.plist
